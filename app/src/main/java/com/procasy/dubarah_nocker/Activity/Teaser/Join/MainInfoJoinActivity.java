...
public class MainInfoJoinActivity extends AppCompatActivity implements Validator.ValidationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_info_join);
...
//        province.setText("Midan");
    ...
    public void GetInfoRequest() {
        ...
        RequestQueue queue = Volley.newRequestQueue(MainInfoJoinActivity.this);
    ...
    public void onValidationSucceeded() {
        if(radioGroup.getCheckedRadioButtonId() != -1) {
            final String gender = ((ToggleButton) radioGroup.findViewById(radioGroup.getCheckedRadioButtonId())).getText().toString();
            ...
            Whole_btn.postDelayed(new Runnable() {  //delay button
                public void run() {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ThirdScreenJoinActivity.class);
