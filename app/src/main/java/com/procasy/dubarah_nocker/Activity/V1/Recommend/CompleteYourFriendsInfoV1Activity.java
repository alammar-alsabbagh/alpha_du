...
import com.procasy.dubarah_nocker.Activity.Teaser.BroadCastActivity;
...
public class CompleteYourFriendsInfoV1Activity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    public void GetInfoRequest() {
        ...
        RequestQueue queue = Volley.newRequestQueue(CompleteYourFriendsInfoV1Activity.this);
