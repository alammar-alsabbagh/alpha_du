...
public class CompleteYourInfoV1Activity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    ToggleButton Male, Female, Bisexual;
    TextView gender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_your_info_v1);
        ...
        Male = (ToggleButton) findViewById(R.id.sel1);
        Female = (ToggleButton) findViewById(R.id.sel2);
        Bisexual = (ToggleButton) findViewById(R.id.sel2);
        ...
        Male.setTypeface(typface);
        Female.setTypeface(typface);
        Bisexual.setTypeface(typface);
        t1.setTypeface(bold);
        t2.setTypeface(typface);
        t3.setTypeface(typface);
        t4.setTypeface(typface);
        gender.setTypeface(typface);
    ...
    public void GetInfoRequest() {
        ...
        RequestQueue queue = Volley.newRequestQueue(CompleteYourInfoV1Activity.this);
        ...
        if (toggleGroup.getCheckedRadioButtonId() != -1) {
            ...
            Whole_btn.postDelayed(new Runnable() {  //delay button
                public void run() {
                    ...
                    Intent intent = new Intent(getApplicationContext(), com.procasy.dubarah_nocker.Activity.V1.Recommend.ChooseSkillsV1Activity.class);
