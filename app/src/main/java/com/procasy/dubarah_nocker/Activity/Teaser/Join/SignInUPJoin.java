...
import com.procasy.dubarah_nocker.Activity.Teaser.MainInfoActivity;
...
public class SignInUPJoin extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
...
SessionManager sessionManager;
    TextView t1,t6,t9,t7,t8;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sign_in_up_join);
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                                ...
                                new GraphRequest.GraphJSONObjectCallback() {
                                    ...
                                    public void onCompleted(JSONObject object, GraphResponse response) {
                                        ...
                                        try {
                                            ...
                                            startActivity(new Intent(getApplicationContext(),MainInfoJoinActivity.class));
                    ...
                    public void onCancel() {
                        Toast.makeText(SignInUPJoin.this, "Login Cancel", Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onError(FacebookException exception) {
                        Toast.makeText(SignInUPJoin.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
        ...
        signupFB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LoginManager.getInstance().logInWithReadPermissions(SignInUPJoin.this, Arrays.asList("public_profile", "user_friends", "email"));
            }
        });
        signupLinkedin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LISessionManager.getInstance(getApplicationContext()).init(SignInUPJoin.this, buildScope(), new AuthListener() {
                    @Override
                        ...
                        apiHelper.getRequest(getApplicationContext(), url, new ApiListener() {
                            ...
                            public void onApiSuccess(ApiResponse apiResponse) {
                                ...
                                try {
                                    ...
                                    sessionManager.setFName(object.getString("lastName"));
