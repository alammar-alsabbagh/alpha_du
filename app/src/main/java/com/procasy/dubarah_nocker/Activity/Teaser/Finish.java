...
public class Finish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        person_name.setText(sessionManager.getKey_his_name());
        person_skill.setText(sessionManager.getKey_his_skill());
        ...
        cursor.moveToFirst();
        sessionManager.setKeyHisPhone(cursor.getString(5).toString());
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Whole_btn.postDelayed(new Runnable() {  //delay button
                                                public void run() {
                                                    ...
                                                    final ACProgressFlower dialog = new ACProgressFlower.Builder(Finish.this)
